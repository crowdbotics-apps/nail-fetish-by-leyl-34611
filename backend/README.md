...
## Project Structure
    ...
    ├── nail_fetish_by_leyl_34611  # Django project configurations
...
1. Clone this repo and `cd nail_fetish_by_leyl_34611`
...
2. Clone this repo and `cd nail_fetish_by_leyl_34611`
